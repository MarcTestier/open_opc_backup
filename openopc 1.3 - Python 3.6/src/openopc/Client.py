...
class Client:
    ...
    def connect(self, opc_server=None, opc_host='localhost'):
        ...
        print("Blop 3 %s - %s" % (opc_server, opc_host))
        opc_host = "172.16.23.112"
